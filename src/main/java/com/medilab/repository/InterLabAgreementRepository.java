...
public interface InterLabAgreementRepository extends JpaRepository<InterLabAgreement, Long> {
    ...
    Page<InterLabAgreement> findByPartnerLabIdAndStatus(Long partnerLabId, AgreementStatus status, Pageable pageable);
    ...
    Page<InterLabAgreement> findByLabIdAndStatus(@Param("labId") Long labId, @Param("status") AgreementStatus status,
            Pageable pageable);
