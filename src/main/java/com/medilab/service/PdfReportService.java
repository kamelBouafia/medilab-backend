...
public class PdfReportService {
        ...
        private void addTestResults(Document document, ReportGenerationDto reportData, PdfFont regularFont,
                ...
                for (ReportGenerationDto.TestResultDetail result : reportData.getTestResults()) {
                        ...
                        // Flag cell with color
                        Cell flagCell = createDataCell(result.getFlag(), regularFont, evenRow);
                        if (result.getFlag() != null && !result.getFlag().equals("NORMAL")) {
                                flagCell.setFontColor(ColorConstants.RED);
                        }
